...
{* 9jan2017/5feb2017/12feb2017/28mar2017/13apr2017/24may2017/9jun2017/30jun2017/12jul2017}{...}
...
for a well-illustrated monograph on raw materials.  Brinton (1914, 66)
showed a hybrid (in more recent terms) of a bumps chart and a two-way
bar chart. 
...
{p 8 8 2}panel bar charts (see Rahlf [2017, 110, 214]); and 
...
{p 4 8 2}Greenacre (2007, 42) gave these data from the 1997 Encuesta Nacional 
de la Salud (Spanish National Health Survey):
...
may be needed to handle value labels.
...
ed. A. Krause and M. O'Connell, 41-69. New York: Springer.
...
Using gray in plots. 
{it:Statistical Computing and Statistical Graphics Newsletter} 5(1): 11-14.
...
ed. J. Blasius and M. Greenacre, 37-45.
...
{p 4 8 2}Cook, D., E.-K. Lee, and M. Majumder. 2016. 
Data visualization and statistical graphics in big data analysis. 
{it:Annual Review of Statistics and its Applications} 3: 133-159. 
...
In {it:Softstat '97: Advances in Statistical Software 6: The 9th Conference on the Scientific Use of Statistical Software, March 3-6, 1997},
ed. W. Bandilla and F. Faulbaum, 11-20.
...
{it:International Journal of Industrial Ergonomics} 22: 439-447.
...
ed. T. M. Powell and J. H. Steele, 391-409. 
...
{it:Chemometrics and Intelligent Laboratory Systems} 22: 147-153.
...
{it:Sustainable Energy -- Without the Hot Air}.
Cambridge: UIT Cambridge.

{p 4 8 2}Mackinlay, J. D. 1986.
Automating the design of graphical presentations of relational information.
{it:ACM Transactions on Graphics} 5: 110-141.
...
In 
{it:A Picture is Worth a Thousand Tables: Graphics in Life Sciences},
ed. A. Krause and M. O'Connell, 117-138. New York: Springer.

{p 4 8 2}Mihalisin, T. W. 2002.
Data warfare and multidimensional education.
In
{it:Information Visualization in Data Mining and Knowledge Discovery},
ed. U. Fayyad, G. G. Grinstein, and A. Wierse, 315-344.
San Diego, CA: Academic Press.

{p 4 8 2}Morrison, P. S. 1985.
Symbolic representation of tabular data.
{it:New Zealand Journal of Geography} 79: 11-18.
...
{it:Journal of the American Statistical Association} 44: 485-500.
...
ed. T. Catarci, M. F. Costabile, S. Levialdi, and G. Santucci, 67-80.
...
ed. B. Adelson, S. Dumais, and J. S. Olson, 318-322.
New York: Association for Computing Machinery.
