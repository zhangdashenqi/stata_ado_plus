{smcl}
{* *! version 1.1  04jun2013}{...}
{hline}
help for {cmd:table1}{right:Version 1.1, 4 June 2013}
{hline}
...
For categorical variables the default is to display the proportion using either 0 or 1 decimal place
depending on the total frequency. After each variable's type you may optionally specify a display
format to override the table's default.{p_end}
