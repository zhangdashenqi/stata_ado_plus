...
{cmd:help treatoprobit postestimation}{right: ({browse "http://www.stata-journal.com/article.html?article=st0402":SJ15-3: st0402})}
{hline}

{title:Title}

{p2colset 5 36 38 2}{...}
{p2col:{cmd:treatoprobit postestimation} {hline 2}}Postestimation
tools for treatoprobit{p_end}
{p2colreset}{...}
...
{p 7 14 2}Help:  {helpb treatoprobit} (if installed)
{p_end}
