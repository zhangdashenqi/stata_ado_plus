*! version 1.2.0        25 Jan 2005        Mark Stewart
program define redsar_ll /* b log_likelihood */
	version 8
	args todo b f
	local y    = trim("$ML_y1")
	local doit "$S_sample"
