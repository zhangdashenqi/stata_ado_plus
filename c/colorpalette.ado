*! version 1.0.1  12apr2018 Ben Jann
...
program Graph2
    ...
    syntax [, TItle(passthru) PLabels(str asis) GRopts(str asis) ///
        LColor(str) LWidth(str) VERTical HORizontal * ]
...
program colorpalette_lin // values obtained from brewextra.ado v 1.0.0,21MAR2016
...
// the following functions are based on R's colorspace package
