	...
	if `atype'==1 {
		...
		*************************************************************/
		if "`posttrend'" != ""{
			...
			di _newline(1)
			di in smcl in green _col(20) " Post-Intervention Linear Trend: `t' " _newline
			di  "Treated: `bexp'"
			#delim ;
...
**************************************************/
		...
		********************************************/
		...
		/* Start Loop over time */
			foreach t in `trperiod' {
				di _newline(1)
				di in smcl in green _col(20) "Comparison of Linear Post-Intervention Trends: `t'"
				...
				local bdexp "_b[`prefix'_z_t] +  _b[`prefix'_z_x_t`t']"
