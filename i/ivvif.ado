*! version 1.0.0 21jul2005 by David Roodman, Center for Global Development, www.cgdev.org
...
*	_isfit cons
      ...
      if "`e(cmd)'" != "ivreg" & "`e(cmd)'" != "ivreg2" & "`e(cmd)'" != "regress" {
            di as err "This command only works after -reg-, -ivreg-, and -ivreg2-."
            exit 301
      }
