...
{p 8 21 2}
{cmd:keybygen} [ {varlist} ] , {opth g:enerate(newvarname)} [ {opt replace} {cmdab::no}{cmdab:o:rder} {opt m:issing} {opt fast:} ]
...
{p 4 13 2}
{bind: }Manual: {hi:[D] generate}, {hi:[D] sort}, {hi:[D] gsort}, {hi:[D] merge}, {hi: [D] order}, {hi:[U] 12.2.1 Missing values}
{p_end}
{p 4 13 2}
On-line: help for {helpb generate}, {helpb sort}, {helpb gsort}, {helpb merge}, {helpb order}, {helpb missing}
{break}
