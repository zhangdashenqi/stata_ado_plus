{smcl}
{hline}
{cmd:help: {helpb spglsxt}}{space 55} {cmd:dialog:} {bf:{dialog spglsxt}}
{hline}
...
{p 5 5 6}
{opt spglsxt} {depvar} {indepvars} {weight} , {bf:{err:nc(#)}} {p_end} 
{p 3 5 6} 
...
{p 5 5 6} 
{opt pred:ict(new_var)} {opt res:id(new_var)} {opt coll zero tolog robust} {opt l:evel(#)}{p_end} 
{p 5 5 6} 
...
{bf:{err:* (1) Spatial Panel Autoregressive Generalized Least Squares Regression}}
 {stata spglsxt y  x1 x2 , nc(7) wmfile(SPWxt) mfx(lin)}
 {stata spglsxt y  x1 x2 , nc(7) wmfile(SPWxt) gmm(1)}
 {stata spglsxt y  x1 x2 , nc(7) wmfile(SPWxt) gmm(2)}
 {stata spglsxt y  x1 x2 , nc(7) wmfile(SPWxt) gmm(3)}
{hline}
...
. spglsxt y  x1 x2 , nc(7) wmfile(SPWxt) mfx(lin)
