...
program define spreg_ll_8
	args lnf mu rho1 rho2 rho3 rho4 rho5 rho6 rho7 rho8 sigma
	tempname p1 p2 p3 p4 p5 p6 p7 p8
	scalar `p1' = `rho1'
	scalar `p2' = `rho2'
	scalar `p3' = `rho3'
	scalar `p4' = `rho4'
	...
	qui replace `lnf'= A + ln(normalden( $ML_y1-`rho1'*SL1 - `rho2'*SL2 - `rho3'*SL3 		/// 
		- `rho4'*SL4 - `rho5'*SL5 - `rho6'*SL6 - `rho7'*SL7 - `rho8'*SL8 -`mu', 0, `sigma'))
end
