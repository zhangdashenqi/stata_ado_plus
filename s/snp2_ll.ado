...
program define snp2_ll
	...
	* Compute factors that are relevant for the probabilities 
		...
		qui gen double `Au2' = 1   
		qui gen double `Au2L1' = 1 
		qui gen double `Au2L2' = 0 
		qui gen double `A1' = 0
		qui gen double `A2' = 0
		qui gen double `A3' = 0
		forvalues i=1(1)`K12' {
	...
	* Compute log-likelihood
		...
		qui replace `lnf' = ln(`Fu1u2')  			if `y1'==0 & `y2'==0
		qui replace `lnf' = ln(`Fu1'-`Fu1u2')		if `y1'==0 & `y2'==1
