...
{p2colset 9 17 23 2}{...}
{p2col :{hi:sfkk} {hline 2}}Endogenous stochastic frontier models in the style of {help sfkk##KK2015:{bind:Karakaplan and Kutlu (2015)}}{p_end}
{p2colreset}{...}
...
the methodology provided by {help sfkk##KK2015:{bind:Karakaplan and Kutlu (2015)}}. {opt sfkk} provides
...
See {help sfkk##KK2015:{bind:Karakaplan and Kutlu (2015)}} for a detailed
...
and runs the {helpb frontier:frontier} command.
...
results. For more information about {cmd:test} see {help sfkk##KK2015:{bind:Karakaplan and Kutlu (2015)}}. 
...
resembles that of {help sfkk##KK2015:{bind:Karakaplan and Kutlu (2015)}}. {cmd:nicely} option checks
...
{phang2}{cmd:. {stata "sfkk y x1 x2 x3 z1, cost u(z2) en(z1 z2) i(iv1 iv2) exo(x1 x3) header delve fast(6)"}}{p_end}
{phang2}{cmd:. {stata "sfkk y x1 x2 x3 z1, cost u(z2) en(z1 z2) i(iv1 iv2) leave(x2) header delve fast(6)"}}{p_end}
...
{phang2}{cmd:. {stata "sfkk y x1 x2 z1, prod u(z2, nocons) en(z1 z2) i(iv1 iv2) delve nicely"}}{p_end}
...
{phang2}{cmd:. {stata "sfkk y x1 x2 z1, u(z2) en(z1 z2) i(iv1 iv2) iter(10) compare nicely timer"}}{p_end}

{pmore}Notice that in the last example above, because of {cmd:iterate(10)} specification,
...
{phang2}{cmd:. {stata "sfkk y x1 x2 z1, prod u(z2) en(z1 z2) i(iv1 iv2) fast(0.5) mlmod(vce(robust))"}}{p_end}
...
{phang2}{cmd:. {stata "sfkk y x1 x2 z1 [fweight = count], prod u(z2) en(z1 z2) i(iv1 iv2) delve nicely"}}{p_end}
{phang2}{cmd:. {stata "gen type = 1 + round(uniform())"}}{p_end}
{phang2}{cmd:. {stata "tab type"}}{p_end}
{phang2}{cmd:. {stata "sfkk y x1 x2 z1 i2.type, prod u(z2 i2.type) en(z1 z2) i(iv1 iv2) nicely compare diff tech(dfp nr bfgs) delve"}}{p_end}
    {hline}
...
{phang}
Karakaplan, Mustafa U. (2015) "sfkk: Stata Module for Endogenous Stochastic Frontier
Models in the Style of Karakaplan and Kutlu (2015)" Available at Boston College, 
Department of Economics, Statistical Software Components (SSC)
S458029: {browse "http://econpapers.repec.org/software/bocbocode/S458029.htm"} . Also available at 
{browse www.mukarakaplan.com}{p_end}
