*! version 1.0.1 2014-02-18 | long freese | spost13 release

//  spex 1.3.1 from spost9 for use in spost13

program define spex9
    ...
    *  local userpath "C:/~ToSync/~Projects/stata/spostdata/" // example
    ...
    syntax namelist(id="dataset or command") [, Web User *]
...
capture program drop _optname9
program define _optname9, rclass
