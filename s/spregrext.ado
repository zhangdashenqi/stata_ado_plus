...
tempname Cov D den DVE DVNE Dx E E1 EE1 Eg Eo Eom Ew F 
tempname h Hat idv itv IPhi J K L lf Ls M mfxe mfxlin mfxlog mh olsin
tempname P Phi Pm q Q Qr q1 q2 In WS D WW eVec Xo kbm SSE SST1 SST2
tempname S11 S12 Sig2 Sig2b Sig2o Sig2u We Wi Wi1 Wio WY X X0 XB V
tempname Vec vh VM VP Vs W W1 W2 Wald xq Xx Y Yh YMB YYm YYv Z Z0 Z1 Zo
tempname N DF kx kb NC NT Nmiss llf wmat xAx xAx2 TRa2 wWw1 xBx X0 Sw Ue
tempname kxd kbd Sig21 dfab sigox Dim Sig2o1 Ko Koi rRo kb 
di
scalar `N'=_N
scalar `NC'=`nc'
scalar `NT'=_N/`NC'
