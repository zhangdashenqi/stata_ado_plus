...
mata:
	...
	void lagmyvar(string scalar xvars1, string scalar xvars2 , string scalar ftouse) 
	{
...
void CalcMoran(string scalar zvar, string scalar ztouse) {
...
// Calculating the variances
    ...
    mata mlib add lsplagvar *(), dir(PLUS)
    mata mlib index
