{smcl}
{hline}
{cmd:help: {helpb spregdhp}}{space 55} {cmd:dialog:} {bf:{dialog spregdhp}}
{hline}
...
{hline}
 ...
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) mfx(lin) re}
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) mfx(lin) fe}
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) mfx(lin) be}
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) mfx(log) tolog re}
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) mfx(log) tolog fe}
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) mfx(log) tolog be}
 {stata spregdhp y x1 x2 , nc(7) model(sar) wmfile(SPWxt) tests}
...
{hline}
 ...
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) mfx(lin) re}
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) mfx(lin) fe}
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) mfx(lin) be}
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) mfx(log) tolog re}
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) mfx(log) tolog fe}
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) mfx(log) tolog be}
 {stata spregdhp y x1 x2 , nc(7) model(sdm) wmfile(SPWxt) tests}
...
{bf:{err:(1) Spatial Econometrics Panel Data Regression Models:}}
...
{helpb spmstarxt}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Lag Panel Models
{helpb spmstardxt}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Durbin Panel Models
{helpb spmstardhxt}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Durbin Multiplicative Heteroscedasticity Panel Models
{helpb spmstarhxt}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Lag Multiplicative Heteroscedasticity Panel Models
...
{helpb spregxt}{col 14}Spatial Panel Regression Econometric Models:
{col 14}Complete Stata Module Software Toolkit

{bf:{err:(2) Spatial Econometrics Cross Section Data Regression Models:}}
...
{col 14}(Lag-Error-Durbin-SAC-SPGLS-GS2SLS-GS3SLS-SPML-SPGS-SPIVREG-IVTobit)
{helpb spgmm}{col 14}Spatial Autoregressive GMM Cross Sections Regression
{helpb spmstar}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Lag Cross Sections Models
{helpb spmstard}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Durbin Cross Sections Models
{helpb spmstardh}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Durbin Multiplicative Heteroscedasticity Cross Sections Models
{helpb spmstarh}{col 14}(m-STAR) Spatial Multiparametric Spatio Temporal AutoRegressive Regression:
{col 14}Spatial Lag Multiplicative Heteroscedasticity Cross Sections Models
...
{helpb spregcs}{col 14}Spatial Cross Section Regression Econometric Models:
{col 14}Complete Stata Module Software Toolkit

{bf:{err:(3) Spatial Weight Matrix:}}
...
{bf:{err:(4) Panel Data Regression Models:}}
{helpb xtregdhp}{col 14}Han-Philips (2010) Linear Dynamic Panel Data Regression
{helpb xtregam}{col 14}Amemiya Random-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregbem}{col 14}Between-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregbn}{col 14}Balestra-Nerlove Random-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregfem}{col 14}Fixed-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregmle}{col 14}Trevor Breusch MLE Random-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregrem}{col 14}Fuller-Battese GLS Random-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregsam}{col 14}Swamy-Arora Random-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregwem}{col 14}Within-Effects Panel Data: Ridge & Weighted Regression
{helpb xtregwhm}{col 14}Wallace-Hussain Random-Effects Panel Data: Ridge & Weighted Regression
{helpb xtreghet}{col 14}MLE Random-Effects Multiplicative Heteroscedasticity Panel Data Regression
