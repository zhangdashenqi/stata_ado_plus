...
di _newline(1) "Estimation of the propensity score "

if ("`t_transf'"=="") {
di _newline(1) in ye "The treatment is `t'"
}
if ("`t_transf'"=="ln") {
...
/*di in ye _newline(1) "**************************************************************** "*/
di in ye _newline(0)   "The values of the gpscore evaluated at the representative point of each 
...
/* this line is essential to allow the program glsdoseresponse to withdraw family from glmgpscore */
