{smcl}
{hline}
{cmd:help: {helpb gs2slsarxt}}{space 55} {cmd:dialog:} {bf:{dialog gs2slsarxt}}
{hline}
...
{p 5 5 6}
{opt gs2slsarxt} {depvar} {indepvars} {weight} , {bf:{err:nc(#)}} {opt wmf:ile(weight_file)}{p_end} 
{p 3 5 6} 
...
{marker 02}{bf:{err:{dlgtab:Description}}}
 ...
 {cmd:gs2slsarxt} estimates Generalized Spatial Panel Autoregressive Two Stage Least Squares (GS2SLSAR)
...
{bf:{err:* Generalized Spatial Panel 2SLS Models}}
 {stata gs2slsarxt y x1 x2, nc(7) wmfile(SPWxt) order(1) mfx(lin)}
 {stata gs2slsarxt y x1 x2, nc(7) wmfile(SPWxt) order(2)}
 {stata gs2slsarxt y x1 x2, nc(7) wmfile(SPWxt) order(3)}
 {stata gs2slsarxt y x1 x2, nc(7) wmfile(SPWxt) order(4)}
{hline}

. clear all
. sysuse gs2slsarxt.dta, clear
. gs2slsarxt y x1 x2, nc(7) wmfile(SPWxt) mfx(lin)
...
- R2v= 2.4067   R2v Adj= 2.7314  F-Test =  -25.66 P-Value > F(3 , 39)  1.0000
------------------------------------------------------------------------------
...
{phang}{cmd:GS2SLSARXT: "Stata Module to Estimate Generalized Spatial Panel Autoregressive Two Stage Least Squares (GS2SLSAR)"}{p_end}
