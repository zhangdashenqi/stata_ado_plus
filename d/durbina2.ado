*! version 1.0.11  CFBaum 26nov2003 from
*! version 1.0.9  20nov2002
* 1.0.10: enable onepanel
* 1.0.11: enable if, in

program define durbina2, sort rclass
	syntax [if] [in] [, Lags(numlist integer>0 sort) Robust Small noMiss0 /*
		*/ force ] 
	version 7.0
	...
	qui gen byte `touse' = e(sample)
					...
					/* get time variables */
	_ts timevar panelvar if e(sample), sort onepanel
