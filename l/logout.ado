...
while "``three''"~="" {
	...
	replace ``one''="%XA5%XD8" if ``one''=="-" & ``two''=="-" & ``three''=="-"
	replace ``two''="%XA5%XD8" if ``one''=="%XA5%XD8" & ``two''=="-" & ``three''=="-"
	replace ``three''="%XA5%XD8" if ``one''=="%XA5%XD8" & ``two''=="%XA5%XD8" & ``three''=="-"
	replace ``three''="%XA5%XD8" if ``one''=="%XA5%XD8" & ``two''=="%XA5%XD8" & ``three''=="+"
...
gen height=.
forval num=1/`col_size' {
	qui count if t`num'~="" & t`num'~="%XA5%XD8"
	di "`r(N)' " _c
