*! fsum.ado Full SUMmary program v 2.4.0 fw 2may05
*! keywords: summarize 
...
program define fsum, sortpreserve byable(recall)   
   ...
   syntax [varlist] [fweight aweight] [if] [in] [,Stats(string) Format(string) Pctvar(varlist) /*
      ...
      */ MCATvar(varlist) Decsum  not(varlist)]
   ...
   local allstats n miss abspct mean vari sd se p1 p5 p25 median p75 p95 p99  min max lci uci sum
   ...
   foreach var of varlist `varlist' {
      ...
      if substr("`vartype'",1,3) == "str" {
         ...
         if index("`stats'","Median") == 0 & index("`stats'","P1") == 0 & index("`stats'","P5") == 0  & index("`stats'","P25") == 0 /*
            */  & index("`stats'","P75") == 0  & index("`stats'","P95") == 0  & index("`stats'","P99") == 0 {  
            if("`weight'"==""){
         ...
         if "`varname'" == "varname" {
            if "`tlabel'" != "" {
               di as text "{ralign `startcol' : `tlabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"  as result "{ralign 0:{col `vlabstart'}`var'}"
            }
            else if "`uselabel'" == "uselabel" & "`statalabel'" != "" {
               di as text "{ralign `startcol' : `statalabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`vari'`mean'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"  as result "{ralign 0:{col `vlabstart'}`var'}"
            }
            else {
               di as text "{ralign `startcol' : `var'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"  as result "{ralign 0:{col `vlabstart'}`var'}"
            }
         }
         else {
            if "`tlabel'" != "" {
               di as text "{ralign `startcol' : `tlabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"  as result "{ralign 0:{col `vlabstart'}`varlabel'}"
            }
            else if "`uselabel'" == "uselabel" & "`statalabel'" != "" {
               di as text "{ralign `startcol' : `statalabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"  as result "{ralign 0:{col `vlabstart'}`varlabel'}"
            }
            else {
               di as text "{ralign `startcol' : `var'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"  as result "{ralign 0:{col `vlabstart'}`varlabel'}"
            }
         }
            continue   
         }         
         ...
         *local tlabel : subinstr local tlabel " (code)" ""  // may need to fix code here
         ...
         if "`varname'" == "varname" {
            if "`tlabel'" != "" {
               di as text "{ralign `startcol' : `tlabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'{space `space'}`sum'}"  as result "{ralign 0:{col `vlabstart'}`var'}"
            }
            else if "`uselabel'" == "uselabel" & "`statalabel'" != "" {
               di as text "{ralign `startcol' : `statalabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'{space `space'}`sum'}"  as result "{ralign 0:{col `vlabstart'}`var'}"
            }
            else {
               di as text "{ralign `startcol' : `var'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'{space `space'}`sum'}"  as result "{ralign 0:{col `vlabstart'}`var'}"
            }
            }
         else {
            if "`tlabel'" != ""  {
               di as text "{ralign `startcol' : `tlabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'{space `space'}`sum'}"  as result "{ralign 0:{col `vlabstart'}`varlabel'}"
            }
            else if "`uselabel'" == "uselabel" & "`statalabel'" != "" {
               di as text "{ralign `startcol' : `statalabel'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'{space `space'}`sum'}"  as result "{ralign 0:{col `vlabstart'}`varlabel'}"
            }
            else {
               di as text "{ralign `startcol' : `var'}" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'{space `space'}`sum'}"  as result "{ralign 0:{col `vlabstart'}`varlabel'}"
            }
         }
         if index("`catvar'","`var'") != 0 | index("`mcatvar'","`var'") != 0 {
            local mean 
            ...
            di as text "{ralign `startcol' : `outname' (%) }" " {c |}" as result "{ralign 0:`N'`miss'`abspct'`mean'`vari'`sd'`se'`p1'`p5'`p25'`median'`p75'`p95'`p99'`min'`max'`lci'`uci'`sum'}"
         }
         local abspct
         local miss
      }
