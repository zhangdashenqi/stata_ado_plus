*! version 1.0.0 2013-10-08 same as fitstat 1.9.0 to call in spost13
*  based on version 1.9.0 2012-07-29 in spost9_ado

program define fitstat9, rclass

    local ecmdversion = c(version)
