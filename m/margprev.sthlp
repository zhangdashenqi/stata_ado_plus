...
{cmd:margprev} {ifin} {weight} , [ {opt at:spec(atspec)}
  {opt subpop(subspec)} {opt pr:edict(pred_opt)} {opt vce(vcespec)} {cmdab::no}{opt e:sample} {opt force}
...
The packages {helpb marglmean}, {helpb regpar}, {helpb punaf} and {helpb punafcc} are downloadable from {help ssc:SSC}.
...
{helpb marglmean}, {helpb regpar}, {helpb punaf}, {helpb punafcc}, {helpb parmest} if installed
{p_end}
