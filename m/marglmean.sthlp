...
{cmd:marglmean} {ifin} {weight} , [ {opt at:spec(atspec)}
  {opt subpop(subspec)} {opt pr:edict(pred_opt)} {opt vce(vcespec)} {cmdab::no}{opt e:sample} {cmd:force}
...
Users who need to estimate differences between marginal means
should use {helpb margins} followed by {helpb contrast}.
...
The packages {helpb punaf}, {helpb punafcc}, {helpb margprev} and {helpb regpar}
...
{helpb margprev}, {helpb regpar}, {helpb punaf}, {helpb punafcc}, {helpb parmest} if installed
{p_end}
