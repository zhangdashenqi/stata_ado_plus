*! version 1.0.10 CFBaum 26nov2003 from
*! version 1.0.8 20nov2002
* 1.0.9: enable onepanel
* 1.0.10: enable if, in

program define bgodfrey2, rclass
	syntax [if] [in] [,Lags(numlist integer>0 sort) Small noMiss0 ] 
	version 7.0
	if "`e(vcetype)'" == "Robust" {
